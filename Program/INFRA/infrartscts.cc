...
void experiment (bool enableCtsRts,uint32_t nWifi1,uint32_t nWifi2)
{
  //Enable or disable CTS/RTS
  UintegerValue ctsThr = (enableCtsRts ? UintegerValue (100) : UintegerValue (101));
...
/*-------------------------------Application Definition-------------------------------*/
 ...
 //Node 5 as client.
  ...
  //Capture All
  phy2.EnablePcap ("Infra-Node-5-rtscts",staDevices2.Get(1));
  phy1.EnablePcap ("Infra-AP-1-rtscts",apDevices1.Get(0));
  phy1.EnablePcap ("Infra-AP-2-rtscts",apDevices2.Get(0));
  Simulator::Run ();
  Simulator::Destroy ();
